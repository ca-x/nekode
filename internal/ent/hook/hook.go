...
// Mutate calls f(ctx, m).
func (f InteractionEndpointFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.InteractionEndpointMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.InteractionEndpointMutation", m)
}
...
// The SavedMessageFunc type is an adapter to allow the use of ordinary
// function as SavedMessage mutator.
type SavedMessageFunc func(context.Context, *ent.SavedMessageMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SavedMessageFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SavedMessageMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SavedMessageMutation", m)
}
...
// The TaskAttemptFunc type is an adapter to allow the use of ordinary
// function as TaskAttempt mutator.
type TaskAttemptFunc func(context.Context, *ent.TaskAttemptMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TaskAttemptFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TaskAttemptMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TaskAttemptMutation", m)
}
